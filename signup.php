    ...
    <div class="row d-flex justify-content-center align-items-center">
      <div class="col-xl-8 mb-0">
        <div class="card rounded-3 text-black">
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 pb-md-2 mx-md-4">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  ...
                  <div data-mdb-input-init class="form-outline mb-4">
                  <label class="form-label" for="form2Example11">Eamil</label>
                    <input type="email" id="form2Example11" class="form-control"
                      placeholder="Phone number or email address" />
                  ...
                  <div class="text-center pt-1 pb-1">
                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3 w-100  border-0" type="button">SignUp
                      </button>
